...
The Lysning beta is operated by **Krishna Babuji**, a sole trader ("we", "us"). Contact: **legal@lysning.app**.
...
- **Taking backups is yours to do.** The App gives you the means: **Settings → Data → Back up** writes an encrypted file you keep wherever you choose, and **Settings → Data → Restore** reads one back. **Settings → Data → Export** writes a spreadsheet. Whether a backup exists when you need one is down to you having made it.
...
- **Apple has no obligation to provide any maintenance or support** for the App. All support requests go to **support@lysning.app**.
...
- General and support: **support@lysning.app** — also where the App's own "Send feedback" link goes
