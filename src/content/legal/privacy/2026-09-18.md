...
material: false
changeSummary: 'The website waitlist now also carries beta invitations. Nothing in the app changes.'
---
...
- **If you join the waitlist on our website, we hold your email address** — only because you typed it in, only to invite you to the beta and tell you when Lysning is live, and you can unsubscribe from any message we send. We don't track whether our emails are opened or which links you click. It is never linked to anything in the app.
...
Our website at lysning.app offers an optional waitlist. If you choose to submit it, we receive **your email address** — no name, no financial data, and nothing connected to your use of the app. Our emails carry no tracking pixel and no redirected links, so we do not see whether you opened an email or which links you clicked. If a link takes you to our website, Umami counts that visit the same way it counts any other — in aggregate, with no cookie and nothing that identifies you (Section 5). There is no waitlist in the app, and submitting one is never required to use Lysning.
...
- **Waitlist consent** (UK GDPR Art. 6(1)(a); PECR reg. 22): we email you only because you asked us to, and you confirm that by clicking the link in the confirmation email we send. Unsubscribe via the link in any message, or by emailing **privacy@lysning.app** — either removes you from the list entirely.
...
- **Buttondown** (website waitlist; stores the email address you submit; open and click tracking are switched off)
