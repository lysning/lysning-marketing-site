...
Analytics data is stored by PostHog in the EU (covered by the UK adequacy decision for the EEA). Crash data may be processed by Sentry in the United States. Update checks are handled by Expo in the United States. Waitlist email addresses are stored by Buttondown in the United States; the transfer relies on Standard Contractual Clauses, as set out in Buttondown's data processing agreement.
